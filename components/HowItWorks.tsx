  ...
  return (
    <section id="how-it-works" className="py-24 max-w-6xl mx-auto px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
        <div className="hidden md:block absolute top-8 left-[12.5%] right-[12.5%] h-px bg-linear-to-r from-transparent via-amber-500/25 to-transparent" />
        {HOW_IT_WORKS.map((s, i) => (
          <div key={i} className="flex flex-col items-center text-center gap-4">
            <div className="w-16 h-16 rounded-2xl glass border border-white/8 flex items-center justify-center relative z-10">
